...
export type UMDPackageName =
    ...
    | "babylonjs-core-for-lottie-player";
export type NamespacePackageName =
    ...
    | "BABYLON.core-for-lottie-player";
...
export const umdPackageMapping: { [key in UMDPackageName]: { baseDir: string; baseFilename: string; isBundle?: boolean } } = {
    ...
    "babylonjs-core-for-lottie-player": {
        baseDir: "core-for-lottie-player",
        baseFilename: "babylon.coreForLottiePlayer",
    },
};
...
const packageMapping: {
    ...
    umd: {
        ...
        "core-for-lottie-player": "babylonjs-core-for-lottie-player",
    },
    es6: {
        core: "@babylonjs/core",
        gui: "@babylonjs/gui",
    ...
    namespace: {
        ...
        "core-for-lottie-player": "BABYLON.core-for-lottie-player",
    },
};
