...
import { Vector2, Vector3 } from "core-for-lottie-player/Maths/math.vector.js";
...
export declare class NodeParticleBuildState {
     ...
     */
    get emitterWorldMatrix(): import("core-for-lottie-player/Maths/math.vector.js").Matrix | null;
    /**
     * Gets the emitter inverse world matrix
     */
    get emitterInverseWorldMatrix(): import("core-for-lottie-player/Maths/math.vector.js").Matrix | null;
    /**
