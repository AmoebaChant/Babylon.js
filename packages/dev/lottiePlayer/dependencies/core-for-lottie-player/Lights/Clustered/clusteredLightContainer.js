...
import { StorageBuffer } from "core-for-lottie-player/Buffers/storageBuffer.js";
import { Constants } from "core-for-lottie-player/Engines/constants.js";
import { ShaderMaterial } from "core-for-lottie-player/Materials/shaderMaterial.js";
import { RawTexture } from "core-for-lottie-player/Materials/Textures/rawTexture.js";
import { RenderTargetTexture } from "core-for-lottie-player/Materials/Textures/renderTargetTexture.js";
import { UniformBuffer } from "core-for-lottie-player/Materials/uniformBuffer.js";
import { TmpColors } from "core-for-lottie-player/Maths/math.color.js";
import { TmpVectors, Vector3 } from "core-for-lottie-player/Maths/math.vector.js";
import { CreatePlane } from "core-for-lottie-player/Meshes/Builders/planeBuilder.js";
import { serialize } from "core-for-lottie-player/Misc/decorators.js";
import { _WarnImport } from "core-for-lottie-player/Misc/devTools.js";
import { Logger } from "core-for-lottie-player/Misc/logger.js";
import { RegisterClass } from "core-for-lottie-player/Misc/typeStore.js";
import { Node } from "core-for-lottie-player/node.js";
import { Light } from "../light.js";
import { LightConstants } from "../lightConstants.js";
import "core-for-lottie-player/Meshes/thinInstanceMesh.js";
...
export class ClusteredLightContainer extends Light {
    ...
    _updateBatches(camera = null) {
        ...
        this._lightDataTexture = new RawTexture(this._lightDataBuffer, 5, maxLights, Constants.TEXTUREFORMAT_RGBA, this._scene, false, false, Constants.TEXTURE_NEAREST_SAMPLINGMODE, Constants.TEXTURETYPE_FLOAT);
