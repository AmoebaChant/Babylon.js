import type { Nullable, Immutable, Camera, Scene, AbstractMesh, SubMesh, Material, IParticleSystem, BoundingBox, UniformBuffer, AbstractEngine } from "core-for-lottie-player/index.js";
