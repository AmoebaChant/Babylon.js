...
import { Texture } from "core-for-lottie-player/Materials/Textures/texture.js";
...
export class FluidRenderingTextures {
    ...
    _createBlurPostProcesses(textureBlurSource, textureType, textureFormat, blurSizeDivisor, debugName, useStandardBlur = false) {
        ...
        if (useStandardBlur) {
            const kernelBlurXPostprocess = new PostProcess("BilateralBlurX", "fluidRenderingStandardBlur", ["filterSize", "blurDir"], null, 1, null, Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, true, null, textureType, undefined, undefined, undefined, textureFormat, this._shaderLanguage, 
