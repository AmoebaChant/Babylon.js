...
import { Matrix, Vector2, Vector3 } from "core-for-lottie-player/Maths/math.vector.js";
...
export class FluidRenderingTargetRenderer {
    ...
    _createLiquidRenderingPostProcess() {
        ...
        this._renderPostProcess = new PostProcess("FluidRendering", "fluidRenderingRender", uniformNames, samplerNames, 1, null, Constants.TEXTURE_BILINEAR_SAMPLINGMODE, engine, false, null, Constants.TEXTURETYPE_UNSIGNED_BYTE, undefined, undefined, true, undefined, this._shaderLanguage, 
