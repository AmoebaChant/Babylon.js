...
import { GetTypeForDepthTexture, IsDepthTexture, HasStencilAspect } from "core-for-lottie-player/Materials/Textures/textureHelper.functions.js";
...
export class FrameGraphTextureManager {
    ...
    computeTotalTextureSize(optimizedSize, outputWidth, outputHeight) {
        ...
        this._textures.forEach((entry, handle) => {
            ...
            const blockInfo = FrameGraphTextureManager._GetTextureBlockInformation(options.options.types?.[textureIndex] ?? Constants.TEXTURETYPE_UNSIGNED_BYTE, options.options.formats[textureIndex]);
