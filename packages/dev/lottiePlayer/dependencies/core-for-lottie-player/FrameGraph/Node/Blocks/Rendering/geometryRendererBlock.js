...
export class NodeRenderGraphGeometryRendererBlock extends NodeRenderGraphBlock {
    ...
    constructor(name, frameGraph, scene, doNotChangeAspectRatio = true, enableClusteredLights = true) {
        ...
        this.viewDepthType = Constants.TEXTURETYPE_FLOAT;
        // Normalized view depth
        this.normalizedViewDepthFormat = Constants.TEXTUREFORMAT_RED;
        this.normalizedViewDepthType = Constants.TEXTURETYPE_HALF_FLOAT;
        // Screen depth
        this.screenDepthFormat = Constants.TEXTUREFORMAT_RED;
        this.screenDepthType = Constants.TEXTURETYPE_FLOAT;
        // View normal
        this.viewNormalFormat = Constants.TEXTUREFORMAT_RGBA;
        this.viewNormalType = Constants.TEXTURETYPE_HALF_FLOAT;
        // World normal
