...
import { FrameGraphGlowLayerTask } from "core-for-lottie-player/FrameGraph/Tasks/Layers/glowLayerTask.js";
...
export class NodeRenderGraphGlowLayerBlock extends NodeRenderGraphBlock {
     ...
     */
    constructor(name, frameGraph, scene, ldrMerge = false, layerTextureRatio = 0.5, layerTextureFixedSize, layerTextureType = Constants.TEXTURETYPE_UNSIGNED_BYTE) {
