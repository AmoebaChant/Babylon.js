...
import { FrameGraphHighlightLayerTask } from "core-for-lottie-player/FrameGraph/Tasks/Layers/highlightLayerTask.js";
...
export class NodeRenderGraphHighlightLayerBlock extends NodeRenderGraphBlock {
     ...
     */
    constructor(name, frameGraph, scene, layerTextureRatio = 0.5, layerTextureFixedSize, blurTextureSizeRatio = 0.5, isStroke = false, layerTextureType = Constants.TEXTURETYPE_UNSIGNED_BYTE) {
