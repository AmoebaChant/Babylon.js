...
import { EffectFallbacks } from "core-for-lottie-player/Materials/effectFallbacks.js";
/**
...
export class VolumetricLightScatteringPostProcess extends PostProcess {
    ...
    _createPass(scene, ratio) {
        ...
        this._volumetricLightScatteringRTT = new RenderTargetTexture("volumetricLightScatteringMap", { width: engine.getRenderWidth() * ratio, height: engine.getRenderHeight() * ratio }, scene, false, true, Constants.TEXTURETYPE_UNSIGNED_BYTE);
