...
export class ChromaticAberrationPostProcess extends PostProcess {
     ...
     */
    constructor(name, screenWidth, screenHeight, options, camera, samplingMode, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_BYTE, blockCompilation = false) {
        const localOptions = {
