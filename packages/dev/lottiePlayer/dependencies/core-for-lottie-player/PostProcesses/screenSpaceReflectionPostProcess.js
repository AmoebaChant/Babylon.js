...
export class ScreenSpaceReflectionPostProcess extends PostProcess {
     ...
     */
    constructor(name, scene, options, camera, samplingMode, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_BYTE, blockCompilation = false, forceGeometryBuffer = false) {
