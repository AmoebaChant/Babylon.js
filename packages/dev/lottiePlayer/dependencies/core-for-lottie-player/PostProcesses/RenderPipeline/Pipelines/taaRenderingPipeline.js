...
import { PassPostProcess } from "core-for-lottie-player/PostProcesses/passPostProcess.js";
import { ThinTAAPostProcess } from "core-for-lottie-player/PostProcesses/thinTAAPostProcess.js";
...
class TAAEffectConfiguration {
    constructor() {
        this.name = "taa";
        this.enabled = true;
        this.texturesRequired = [Constants.PREPASS_VELOCITY_LINEAR_TEXTURE_TYPE];
    }
}
/**
...
export class TAARenderingPipeline extends PostProcessRenderPipeline {
    ...
    _createPingPongTextures(width, height) {
        ...
        this._ping?.dispose();
        this._pong?.dispose();
        this._ping = engine.createRenderTargetTexture({ width, height }, { generateMipMaps: false, generateDepthBuffer: false, type: Constants.TEXTURETYPE_HALF_FLOAT, samplingMode: Constants.TEXTURE_LINEAR_LINEAR });
        this._pong = engine.createRenderTargetTexture({ width, height }, { generateMipMaps: false, generateDepthBuffer: false, type: Constants.TEXTURETYPE_HALF_FLOAT, samplingMode: Constants.TEXTURE_LINEAR_LINEAR });
