...
import type { IVector2Like } from "core-for-lottie-player/Maths/math.like.js";
...
export declare class GPUPicker {
    ...
    private _pickingTextureAfterRenderObservable;
     ...
     */
    get defaultRenderMaterial(): Nullable<ShaderMaterial>;
