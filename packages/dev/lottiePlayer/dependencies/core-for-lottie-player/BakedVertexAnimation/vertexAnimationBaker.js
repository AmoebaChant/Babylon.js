...
import { Skeleton } from "core-for-lottie-player/Bones/skeleton.js";
...
export class VertexAnimationBaker {
    ...
    textureFromBakedVertexData(vertexData) {
        ...
        const texture = RawTexture.CreateRGBATexture(vertexData, (boneCount + 1) * 4, vertexData.length / ((boneCount + 1) * 4 * 4), this._scene, false, false, Texture.NEAREST_NEAREST, vertexData instanceof Float32Array ? Constants.TEXTURETYPE_FLOAT : Constants.TEXTURETYPE_HALF_FLOAT);
