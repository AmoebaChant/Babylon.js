...
import { Constants } from "../../Engines.js";
...
import { SpriteManager } from "core-for-lottie-player/Sprites/spriteManager.js";
...
const LoadAssetContainer = (scene, data, rootUrl, onError, addToScene = false) => {
    ...
    try {
        ...
        if (log !== null && SceneLoaderFlags.loggingLevel !== Constants.SCENELOADER_NO_LOGGING) {
            Logger.Log(logOperation("loadAssets", parsedData ? parsedData.producer : "Unknown") + (SceneLoaderFlags.loggingLevel !== Constants.SCENELOADER_MINIMAL_LOGGING ? log : ""));
        }
    }
    return container;
};
RegisterSceneLoaderPlugin({
    ...
    importMesh: (meshesNames, scene, data, rootUrl, meshes, particleSystems, skeletons, onError) => {
        ...
        try {
            ...
            if (log !== null && SceneLoaderFlags.loggingLevel !== Constants.SCENELOADER_NO_LOGGING) {
                Logger.Log(logOperation("importMesh", parsedData ? parsedData.producer : "Unknown") + (SceneLoaderFlags.loggingLevel !== Constants.SCENELOADER_MINIMAL_LOGGING ? log : ""));
            }
            TempMaterialIndexContainer = {};
            TempMorphTargetManagerIndexContainer = {};
        }
    ...
    load: (scene, data, rootUrl, onError) => {
        ...
        try {
            ...
            if (log !== null && SceneLoaderFlags.loggingLevel !== Constants.SCENELOADER_NO_LOGGING) {
                Logger.Log(logOperation("importScene", parsedData ? parsedData.producer : "Unknown") + (SceneLoaderFlags.loggingLevel !== Constants.SCENELOADER_MINIMAL_LOGGING ? log : ""));
            }
        }
        return false;
    },
