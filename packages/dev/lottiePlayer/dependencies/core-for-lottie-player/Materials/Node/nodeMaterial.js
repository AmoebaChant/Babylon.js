...
export class NodeMaterial extends NodeMaterialBase {
     ...
     */
    createPostProcess(camera, options = 1, samplingMode = Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_BYTE, textureFormat = Constants.TEXTUREFORMAT_RGBA) {
    ...
    _createEffectForPostProcess(postProcess, camera, options = 1, samplingMode = Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_BYTE, textureFormat = Constants.TEXTUREFORMAT_RGBA) {
