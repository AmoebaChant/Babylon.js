 ...
 */
PBRBRDFConfiguration.DEFAULT_DIFFUSE_MODEL = Constants.MATERIAL_DIFFUSE_MODEL_E_OREN_NAYAR;
/**
 * Defines the default dielectric specular model used by the material.
 */
PBRBRDFConfiguration.DEFAULT_DIELECTRIC_SPECULAR_MODEL = Constants.MATERIAL_DIELECTRIC_SPECULAR_MODEL_GLTF;
/**
 * Defines the default conductor specular model used by the material.
 */
PBRBRDFConfiguration.DEFAULT_CONDUCTOR_SPECULAR_MODEL = Constants.MATERIAL_CONDUCTOR_SPECULAR_MODEL_GLTF;
__decorate([
    serialize(),
