...
import { _executeWhenRenderingStateIsCompiled, _isRenderingStateCompiled, _preparePipelineContext, createPipelineContext, getStateObject } from "core-for-lottie-player/Engines/thinEngine.functions.js";
import { _GetGlobalDefines } from "core-for-lottie-player/Engines/abstractEngine.functions.js";
import { ShaderStore } from "core-for-lottie-player/Engines/shaderStore.js";
import { WebGL2ShaderProcessor } from "core-for-lottie-player/Engines/WebGL/webGL2ShaderProcessors.js";
import { _RetryWithInterval } from "core-for-lottie-player/Misc/timingTools.js";
/**
...
export async function generatePipelineContext(options, context, createPipelineContextInjection = createPipelineContext.bind(null, context), _preparePipelineContextInjection = _preparePipelineContext) {
    ...
    if (!processor) {
        switch (platformName) {
            case "WEBGL1":
                processor = new (await import("core-for-lottie-player/Engines/WebGL/webGLShaderProcessors.js")).WebGLShaderProcessor();
                break;
            case "WEBGL2":
            default:
