 ...
 */
export function PrepareDefinesForIBL(scene, reflectionTexture, defines, realTimeFiltering = false, realTimeFilteringQuality = Constants.TEXTURE_FILTERING_QUALITY_LOW, forceSHInVertex = false) {
    if (reflectionTexture && MaterialFlags.ReflectionTextureEnabled) {
