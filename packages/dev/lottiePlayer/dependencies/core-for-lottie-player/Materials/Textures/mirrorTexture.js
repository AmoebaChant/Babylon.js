...
export class MirrorTexture extends RenderTargetTexture {
     ...
     */
    constructor(name, size, scene, generateMipMaps, type = Constants.TEXTURETYPE_UNSIGNED_BYTE, samplingMode = Texture.BILINEAR_SAMPLINGMODE, generateDepthBuffer = true) {
