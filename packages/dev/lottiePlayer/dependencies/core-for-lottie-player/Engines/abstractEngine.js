...
export class AbstractEngine {
    ...
    get emptyCubeTexture() {
        if (!this._emptyCubeTexture) {
            ...
            this._emptyCubeTexture = this.createRawCubeTexture(cubeData, 1, Constants.TEXTUREFORMAT_RGBA, Constants.TEXTURETYPE_UNSIGNED_BYTE, false, false, Constants.TEXTURE_NEAREST_SAMPLINGMODE);
        }
