...
import { _GetCompatibleTextureLoader } from "core-for-lottie-player/Materials/Textures/Loaders/textureLoaderManager.js";
...
export class NativeEngine extends Engine {
    ...
    createRawTexture(data, width, height, format, generateMipMaps, invertY, samplingMode, compression = null, type = Constants.TEXTURETYPE_UNSIGNED_BYTE, creationFlags = 0, useSRGBBuffer = false) {
    ...
    createRawTexture2DArray(data, width, height, depth, format, generateMipMaps, invertY, samplingMode, compression = null, textureType = Constants.TEXTURETYPE_UNSIGNED_BYTE) {
    ...
    updateRawTexture(texture, bufferView, format, invertY, compression = null, type = Constants.TEXTURETYPE_UNSIGNED_BYTE, useSRGBBuffer = false) {
        if (!texture) {
            return;
        }
