...
import { RegisterMaterialPlugin, UnregisterMaterialPlugin } from "core-for-lottie-player/Materials/materialPluginManager.js";
import { Matrix } from "core-for-lottie-player/Maths/math.vector.js";
...
export class WebXRDepthSensing extends WebXRAbstractFeature {
    ...
    _updateDepthInformationAndTextureCPUDepthUsage(frame, view, dataFormat) {
        ...
        if (!this._cachedDepthImageTexture) {
            this._cachedDepthImageTexture = RawTexture.CreateRTexture(null, width, height, this._xrSessionManager.scene, false, false, Texture.NEAREST_SAMPLINGMODE, Constants.TEXTURETYPE_FLOAT);
    ...
    _updateDepthInformationAndTextureWebGLDepthUsage(webglBinding, view, dataFormat) {
        ...
        if (!this._cachedDepthImageTexture) {
            this._cachedDepthImageTexture = RawTexture.CreateRTexture(null, width, height, scene, false, true, Texture.NEAREST_SAMPLINGMODE, dataFormat === "float" ? Constants.TEXTURETYPE_FLOAT : Constants.TEXTURETYPE_UNSIGNED_BYTE);
        }
    ...
    _getInternalTextureFromDepthInfo() {
        ...
        const internalTexture = engine.wrapWebGLTexture(this._cachedWebGLTexture, false, Constants.TEXTURE_NEAREST_SAMPLINGMODE, this._width || 256, this._height || 256);
